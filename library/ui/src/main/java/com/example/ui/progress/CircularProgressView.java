...
public class CircularProgressView extends View {
    ...
    public CircularProgressView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (isInEditMode()) {
            mColors = new int[4];
            mColors[0] = getResources().getColor(android.R.color.holo_red_light);
            mColors[1] = getResources().getColor(android.R.color.holo_red_light);
            mColors[2] = getResources().getColor(android.R.color.holo_red_light);
            mColors[3] = getResources().getColor(android.R.color.holo_red_light);
        } else {

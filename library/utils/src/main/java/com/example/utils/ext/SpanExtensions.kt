...
fun CharSequence.toImageSpan(imageSpan: ImageSpan, range: IntRange = IntRange(0, length)): SpannableString {
    return SpannableString(this).apply {
        setSpan(imageSpan, range.first, range.last, Spannable.SPAN_INCLUSIVE_EXCLUSIVE)
    }
}
